...
import { MdCallSplit, MdOutlineLeaderboard } from "react-icons/md";
...
export function DashboardLayout() {
  ...
  const navItems = [
    ...
    { href: "/leads", label: "Leads", Icon: MdOutlineLeaderboard },
    { href: "/workflow", label: "Flow", Icon: GoWorkflow },
    { href: "/knowledge-base", label: "Knowledgebase", Icon: IoMdDocument },
   
    { href: "/phone-numbers", label: "Phone Numbers", Icon: MdCallSplit },

    { href: "/assistants", label: "Assistants", Icon: TbRobot },
    { href: "/campaign", label: "SMS Campaign", Icon: LuMessageSquareMore },
    { href: "/setting", label: "Setting", Icon: TbSettings },
  ];
